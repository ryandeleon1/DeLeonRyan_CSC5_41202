...
void sortScores(string[],int[],int);
...
//******************************************************************************
bool assgnLoc(int c[], short s, short l){
    if (s==1 && l==1) return true;
    else if (s==2 && l==2) return true;
    else if (s==3 && l==4) return true;
    else if (s==4 && l==5) return true;
    else return false;
}

void fillNames(string n[ROW][COL],int row, int col, string &nam){
